...
const getAllFuel_Consumption = (req, res) => {
  var query = "SELECT * FROM FuelConsumption ORDER BY ID DESC";
  let { cond, limit, fullquery } = req.query;
  if (limit) {
    query = "SELECT TOP " + limit + " * FROM FuelConsumption";
  } else {
    query = "SELECT * FROM FuelConsumption ORDER BY ID DESC";
  }
  if (cond) {
...
const getFuel_Consumption = (req, res) => {
...
const addFuel_Consumption = (req, res) => {
  var getquery =
...
const updateFuel_Consumption = (req, res) => {
  var getquery =
    "SELECT name FROM sys.columns WHERE object_id = OBJECT_ID('FuelConsumption')";
  var Results = [];
  var cond = "";
...
const deleteFuel_Consumption = (req, res) => {
  // var query = 'SELECT * FROM Fuel_Consumption';
  // console.log(query);
...
module.exports = {
  getAllFuel_Consumption,
  getFuel_Consumption,
  addFuel_Consumption,
  updateFuel_Consumption,
  deleteFuel_Consumption,
};
